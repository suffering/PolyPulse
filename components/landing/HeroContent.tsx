            ...
            <div className="h-[380px] overflow-y-auto sidebar-scroll">
                  ...
                  {events && events.length > 0 ? (
                    events.map((event) => (
                      <a
                        ...
                        className="flex items-center justify-between p-3 bg-[#0a0a0a] border border-[#1a1a1a] rounded-lg hover:border-[#333] hover:shadow-lg hover:shadow-purple-950/30 transition-all duration-200"
                      >
              ...
              {slides[currentSlide].type === "volume" && (
                <div className="grid grid-cols-2 gap-3 animate-fade-in">
                  {volume ? (
                    <>
                      <div className="p-4 bg-[#0a0a0a] border border-[#1a1a1a] rounded-lg hover:border-[#333] hover:shadow-lg hover:shadow-purple-950/30 transition-all duration-200">
