                  ...
                  {events && events.length > 0 ? (
                    events.map((event) => (
                      <a
                        ...
                        className="flex items-center justify-between p-3 bg-[#0a0a0a] border border-[#1a1a1a] rounded-lg hover:border-[#333] hover:shadow-[0_0_20px_rgba(147,51,234,0.4)] transition-all duration-200"
                      >
